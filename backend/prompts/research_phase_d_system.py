"""
Thesis Phase D System Prompt - Abductive Artifact Design & Kernel Theory Grounding.
...
2. Start IMMEDIATELY with `# Phase D Artifact Specification: [Artifact Name]`.
3. Ground the proposed mechanism in established Kernel Theories (e.g., Cognitive Load Theory, Information Theory, Queueing Models).
4. Explicitly categorize the artifact into Construct, Model, Method, or Instantiation.
