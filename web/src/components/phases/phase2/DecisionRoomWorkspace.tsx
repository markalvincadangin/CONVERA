        ...
        {candidates.map((cand) => {
          ...
          return (
            <div
              ...
              role="button"
              tabIndex={0}
              aria-label={`Select candidate thesis ${cand.id}`}
              ...
              className={`cursor-pointer transition-all duration-200 rounded-2xl p-4 flex flex-col justify-between border space-y-3 relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 ${
                isSelected
